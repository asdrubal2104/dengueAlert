...
export const AlertOverlay: React.FC<AlertOverlayProps> = ({
  ...
  return (
    ...
    >
      ...
      <div style={{ textAlign: 'center', margin: '12px 0 24px 0', maxWidth: '440px', width: '100%' }}>
        <div
          style={{
            marginBottom: '16px',
            display: 'flex',
        ...
        >
          ...
          >
            {esGrave ? <Siren size={48} color="#FFFFFF" /> : <AlertTriangle size={48} color="#FFFFFF" />}
          </div>
        </div>

        <h1 style={{ fontSize: '1.625rem', fontWeight: 800, marginBottom: '8px', lineHeight: 1.25, letterSpacing: '-0.01em' }}>
          {esGrave ? '¡EMERGENCIA MÉDICA GRAVE!' : '¡ATENCIÓN: SIGNOS DE ALARMA!'}
        </h1>

        <p style={{ fontSize: '0.9375rem', opacity: 0.95, lineHeight: 1.45, marginBottom: '20px', color: '#FFF' }}>
          {esGrave
        ...
        {sintomasCriticos.length > 0 && (
          ...
          >
            ...
            <ul style={{ paddingLeft: '18px', margin: 0, fontSize: '0.875rem', lineHeight: 1.4 }}>
